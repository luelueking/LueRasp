...
public class TomcatHttpVisitorAdapter extends AdviceAdapter {

    public TomcatHttpVisitorAdapter(MethodVisitor mv, int access, String name, String desc) {
    ...
    public void onMethodEnter() {
        ...
        mv.visitMethodInsn(INVOKEVIRTUAL, "com/lue/rasp/hook/TomcatHttpHook", "storeRequestInfo", "(Ljava/lang/Object;Ljava/lang/Object;)V", false);
